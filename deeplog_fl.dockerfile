...
RUN pip install keras==2.3.1 tqdm git+https://www.github.com/keras-team/keras-contrib.git

COPY deeplogTF /deeplogTF

RUN python -m pip install markupsafe==2.0.1 && pip install numpy==1.19.5

RUN cd deeplogTF && test-sgx.sh make
